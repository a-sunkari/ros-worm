...
def meshfix_repair(mesh, joincomp: bool, remove_smallest_components: bool):
    ...
    mf.repair(verbose=False, joincomp=joincomp, remove_smallest_components=remove_smallest_components)
    v = np.asarray(mf.v, dtype=np.float64)
    f = np.asarray(mf.f, dtype=np.int64)
